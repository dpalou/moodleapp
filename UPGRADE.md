...
=====
 ...
 - Due to the Capacitor migration, navigator.splashcreen no longer exists. Use the exported SplashScreen instance instead.
...
=====
 ...
 - SplashScreen singleton has been deprecated, use navigator.splashscreen directly.
